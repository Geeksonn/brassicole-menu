...
const RouteTitle: React.FunctionComponent<Props> = ({ accent, number, title }) => {
    return (
        <div className={`flex items-center -mt-6 mb-20 rounded-full lg:mt-12 lg:mb-20 bg-${accent}`}>
            <div className='pl-1 pr-5 font-title font-bold text-5xl text-white/30 lg:text-8xl lg:pl-2'>{number}</div>
